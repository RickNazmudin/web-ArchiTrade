...
const images = ["/ebook1.jpg", "/ebook2.jpg", "/ebook3.jpg", "/ebook4.jpg"];

const ToolsMarqueeComponent = () => {
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed">
              Trading Forex dari Nol Panduan Lengkap untuk Pemula hingga mahir.
              Pelajari strategi terbaik, manajemen risiko, dan psikologi trading
              dari para ahli.
            </p>
            ...
            <div className="overflow-hidden">
              ...
              >
                {images.map((img, index) => (
                  <div
                    key={index}
                    className="flex-[0_0_100%] min-w-0 relative h-80 md:h-96 lg:h-[28rem] rounded-xl overflow-hidden shadow-xl"
                  >
                    <Image
                      src={img}
...
export const ToolsMarquee = React.memo(ToolsMarqueeComponent);
