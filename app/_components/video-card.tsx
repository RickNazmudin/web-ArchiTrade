...
export function HeroVideoDialogDemo() {
  ...
  const brokers = {
    ...
    icmarket: {
      ...
      image: "/ICMarket.png", // Pastikan file ini ada di public folder
  ...
  // Fungsi untuk mendapatkan warna berdasarkan broker aktif
  ...
  // Fungsi untuk mendapatkan warna teks berdasarkan broker aktif
